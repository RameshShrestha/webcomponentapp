...
function UsersDetailPage({ navigation, route }) {
    ...
    const UserDataChanged = Object.assign({}, userData);
                    ...
                    <ObjectPageHeader>
                        <FlexBox alignItems="Center" wrap="Wrap">
                            <FlexBox direction="Column">
                                <span> <Icon name="call" /><Link>{userData.phone}</Link></span>
                                <span> <Icon name="email" /> <Link href={"mailto:" + userData.email}>{userData.email}</Link></span>

                            </FlexBox>
                            {userData.address && (
                                <FlexBox direction="Column" style={{ padding: '10px' }}>
                                    <Label>{userData.address.city}</Label><Label>{userData.address.address}</Label>
                                </FlexBox>
                            )}
                        </FlexBox>
                    </ObjectPageHeader>}
            ...
            >
                ...
                >
                    ...
                    >
                        {userData.company &&
                            <FormGroup >
                                <FormItem label="" labelContent={<Label>Company Name</Label>}>
                                ...
                                <FormItem label="Title" labelContent={<Label>Designation</Label>}>
                                ...
                                {userData.company.address && <>
                                    <FormItem label="" labelContent={<Label>Address</Label>}>
